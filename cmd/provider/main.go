...
import (
	...
	"github.com/crossplane-contrib/provider-nop/internal/controller"
)

func main() {
	var (
		app            = kingpin.New(filepath.Base(os.Args[0]), "Nop support for Crossplane.").DefaultEnvars()
	...
	kingpin.FatalIfError(controller.Setup(mgr, log, rl), "Cannot setup Nop controllers")
